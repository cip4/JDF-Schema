...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xalan="http://xml.apache.org/xalan" xmlns:redirect="org.apache.xalan.lib.Redirect" extension-element-prefixes="redirect" exclude-result-prefixes="xsd xalan">
	...
	<xsl:template name="checkAttributeGroup">
		...
		<xsl:for-each select="xalan:nodeset($Phase2Schema)//*[substring(./@ref,(string-length(./@ref)- string-length($cGlobal/@Name))+1)=$cGlobal/@Name]">
							<xsl:element name="GlobalReused">
				...
				<xsl:attribute name="uName"><xsl:value-of select="ancestor-or-self::*[local-name(parent::*)='schema']/@name"/>					     </xsl:attribute>
				<xsl:attribute name="uType"><xsl:value-of select="local-name(ancestor-or-self::*[local-name(parent::*)='schema'])"/></xsl:attribute>
				<xsl:attribute name="uFile"><xsl:value-of select="ancestor-or-self::*[local-name()='schema']/@file"/></xsl:attribute>
			</xsl:element>
	...
	<xsl:template name="checkElement">
		...
		<xsl:for-each select="xalan:nodeset($Phase2Schema)//*[substring(./@ref,(string-length(./@ref)- string-length($cGlobal/@Name))+1)=$cGlobal/@Name]">
			<xsl:element name="GlobalReused">
				...
				<xsl:attribute name="cFile"><xsl:value-of select="$cGlobal/@DefinFile"/></xsl:attribute>
				<xsl:attribute name="uName"><xsl:value-of select="ancestor-or-self::*[local-name(parent::*)='schema']/@name"/>					     </xsl:attribute>
				<xsl:attribute name="uType"><xsl:value-of select="local-name(parent::*)='schema'"/></xsl:attribute>
				<xsl:attribute name="uFile"><xsl:value-of select="ancestor-or-self::*[local-name()='schema']/@file"/></xsl:attribute>
			</xsl:element>
		</xsl:for-each>
	</xsl:template>
	...
	<xsl:template name="checkSimpleType">
		...
		<xsl:for-each select="xalan:nodeset($Phase2Schema)//*[substring(./@type,(string-length(./@type)- string-length($cGlobal/@Name))+1)=$cGlobal/@Name]">
			<xsl:element name="GlobalReused">
				<xsl:attribute name="cName"><xsl:value-of select="$cGlobal/@Name"/></xsl:attribute>
				<xsl:attribute name="cType"><xsl:value-of select="$cGlobal/@Type"/></xsl:attribute>
				<xsl:attribute name="cFile"><xsl:value-of select="$cGlobal/@DefinFile"/></xsl:attribute>
				<xsl:attribute name="uName"><xsl:value-of select="ancestor-or-self::*[local-name(parent::*)='schema']/@name"/>					     </xsl:attribute>
				<xsl:attribute name="uType"><xsl:value-of select="local-name()"/></xsl:attribute>
				<xsl:attribute name="uFile"><xsl:value-of select="ancestor-or-self::*[local-name()='schema']/@file"/></xsl:attribute>
			</xsl:element>
		</xsl:for-each>
		<!-- Check for extension/restriction -->
		<xsl:for-each select="xalan:nodeset($Phase2Schema)//*[substring(./@base,(string-length(./@base)- string-length($cGlobal/@Name))+1)=$cGlobal/@Name]">
			<xsl:element name="GlobalReused">
				<xsl:attribute name="cName"><xsl:value-of select="$cGlobal/@Name"/></xsl:attribute>
				<xsl:attribute name="cType"><xsl:value-of select="$cGlobal/@Type"/></xsl:attribute>
				<xsl:attribute name="cFile"><xsl:value-of select="$cGlobal/@DefinFile"/></xsl:attribute>
		...
		<!-- Check for list -->
		<xsl:for-each select="xalan:nodeset($Phase2Schema)//*[substring(./@itemType,(string-length(./@itemType)- string-length($cGlobal/@Name))+1)=$cGlobal/@Name]">
			<xsl:element name="GlobalReused">
				<xsl:attribute name="cName"><xsl:value-of select="$cGlobal/@Name"/></xsl:attribute>
				<xsl:attribute name="cType"><xsl:value-of select="$cGlobal/@Type"/></xsl:attribute>
				<xsl:attribute name="cFile"><xsl:value-of select="$cGlobal/@DefinFile"/></xsl:attribute>
		...
		<!-- Check for union -->
		<xsl:for-each select="xalan:nodeset($Phase2Schema)//*[substring(./@memberType,(string-length(./@memberType)- string-length($cGlobal/@Name))+1)=$cGlobal/@Name]">
			<xsl:element name="GlobalReused">
				<xsl:attribute name="cName"><xsl:value-of select="$cGlobal/@Name"/></xsl:attribute>
				<xsl:attribute name="cType"><xsl:value-of select="$cGlobal/@Type"/></xsl:attribute>
				<xsl:attribute name="cFile"><xsl:value-of select="$cGlobal/@DefinFile"/></xsl:attribute>
